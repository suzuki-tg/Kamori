...
def restart():
    if "KAMORI_DO_NOT_RESTART" in os.environ:
        print(
            ...
            " packages and then restart Kamori. Run `pip uninstall -y telethon"
            " telethon-mod kamori-tl pyrogram kamori-pyro`, then restart Kamori."
        )
        sys.exit(0)
    ...
    os.environ["KAMORI_DO_NOT_RESTART"] = "1"
