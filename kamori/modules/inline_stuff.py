...
class InlineStuff(loader.Module):
    ...
    @loader.command()
    async def ch_kamori_bot(self, message: Message):
        ...
        self._db.set("kamori.inline", "custom_bot", args)
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        await message.answer_photo(
            "https://github.com/suzuki-tl/assets/raw/master/kamori_banner.png",
            caption=self.strings("this_is_kamori"),
      )
