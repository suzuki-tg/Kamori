...
class UpdaterMod(loader.Module):
    ...
    async def restart_common(
        ...
        msg_obj = await utils.answer(
            ...
            self.strings("restarting_caption").format(
                ...
                if self._client.kamori_me.premium
                and CUSTOM_EMOJIS
    ...
    async def _add_folder(self):
        ...
        if any(getattr(folder, "title", None) == "kamori" for folder in folders):
            return
        ...
        try:
            ...
            logger.critical(
                "Can't create Kamori folder. Possible reasons are:\n"
