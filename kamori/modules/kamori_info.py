...
@loader.tds
class KamoriInfoMod(loader.Module):
    """Show userbot info"""

    strings = {"name": "KamoriInfo"}
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://github.com/suzuki-tl/assets/raw/master/kamori_banner.mp4",
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        me = '<b><a href="tg://user?id={}">{}</a></b>'.format(
            self._client.kamori_me.id,
            utils.escape_html(get_display_name(self._client.kamori_me)),
        )
        ...
        return (
            (
                "<b>🌲 Kamori</b>\n"
                if "kamori" not in self.config["custom_message"].lower()
                else ""
            )
                ...
                *map(
                    ...
                    (
                        (
                            ...
                            if self._client.kamori_me.premium and not inline
                            else "🌲 Kamori"
                        ),
    ...
    @loader.inline_handler(
        thumb_url="https://github.com/suzuki-tl/Kamori/raw/master/assets/kamori_pfp.png"
    )
    ...
    async def info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/suzuki-tl/Kamori/raw/master/assets/kamori_pfp.png"
            ),
    ...
    @loader.command()
    async def kamoriinfo(self, message: Message):
