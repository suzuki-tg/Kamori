...
KamoriReplyMarkup = typing.Union[typing.List[typing.List[dict]], typing.List[dict], dict]
...
class Module:
    ...
    @property
    def kamori_commands(self) -> typing.Dict[str, Command]:
        """List of commands that module supports"""
        return get_commands(self)
    ...
    @property
    def kamori_inline_handlers(self) -> typing.Dict[str, Command]:
        """List of inline handlers that module supports"""
        return get_inline_handlers(self)
    ...
    @property
    def kamori_callback_handlers(self) -> typing.Dict[str, Command]:
        """List of callback handlers that module supports"""
        return get_callback_handlers(self)
    ...
    @property
    def kamori_watchers(self) -> typing.Dict[str, Command]:
        """List of watchers that module supports"""
        return get_watchers(self)
    ...
    @kamori_commands.setter
    def kamori_commands(self, _):
        pass
    ...
    @kamori_inline_handlers.setter
    def kamori_inline_handlers(self, _):
        pass
    ...
    @kamori_callback_handlers.setter
    def kamori_callback_handlers(self, _):
        pass
    ...
    @kamori_watchers.setter
    def kamori_watchers(self, _):
        pass
    ...
    async def animate(
        ...
        *,
        ...
        with contextlib.suppress(AttributeError):
            _kamori_client_id_logging_tag = copy.copy(self.client.tg_id)  # noqa: F841
    ...
    async def _decline(
        ...
        self._db.set(
            "kamori.main",
            "declined_joins",
            list(set(self._db.get("kamori.main", "declined_joins", []) + [channel.id])),
        )
        event.status = False
        event.set()
        await call.edit(
    ...
    async def request_join(
        ...
        if channel.id in self._db.get("kamori.main", "declined_joins", []):
            if assure_joined:
                raise LoadError(
        ...
        self.kamori_wait_channel_approve = (
            self.__class__.__name__,
            channel,
            reason,
        )
        ...
        with contextlib.suppress(AttributeError):
            delattr(self, "kamori_wait_channel_approve")
    ...
    async def import_lib(
        ...
        *,
        ...
        if re.search(r"# ?scope: ?kamori_min", code):
            ver = tuple(
                map(
                    int,
                    re.search(r"# ?scope: ?kamori_min ((\d+\.){2}\d+)", code)[1].split(
                        "."
                    ),
                )
            )
            ...
            if version.__version__ < ver:
                _raise(
                    RuntimeError(
                        f"Library requires Kamori version {'{}.{}.{}'.format(*ver)}+"
                    )
                )

        module = f"kamori.libraries.{url.replace('%', '%%').replace('.', '%d')}"
        ...
        if (
            ...
            and self._db.get("kamori.main", "stats", True)
            and url is not None
...
class DragonModule:
    ...
    def __init__(self):
        ...
        self.commands = {}
        self.watchers = {}
        self.kamori_watchers = {}
        self.inline_handlers = {}
        self.kamori_inline_handlers = {}
        self.callback_handlers = {}
        self.kamori_callback_handlers = {}
