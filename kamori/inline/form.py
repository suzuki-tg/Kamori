...
class Form(InlineUnit):
    async def form(
        ...
        *,
        ...
        :param manual_security: By default, Kamori will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Kamori will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _kamori_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
            ...
            try:
                status_message = await (
                    ...
                    (
                        ...
                        if self._client.kamori_me.premium and CUSTOM_EMOJIS
                        else "🌲"
                    )
                ...
                await inline_query.answer(
                    [
                        InlineQueryResultPhoto(
                            ...
                            thumb_url=(
                                "https://img.icons8.com/fluency/48/deciduous-tree.png"
                            ),
                ...
                await inline_query.answer(
                    [
                        InlineQueryResultAudio(
                            ...
                            caption=form.get("text"),
                            parse_mode="HTML",
                            title=form["audio"].get("title", "Kamori"),
