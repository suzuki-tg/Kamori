...
eval "cat ~/Kamori/assets/download.txt"
printf "\n\n\033[1;35mKamori is being installed... 🌲\033[0m"
...
eval "rm -rf ~/Kamori 2>/dev/null"
eval "cd && git clone https://github.com/suzuki-tl/Kamori && cd Kamori"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/suzuki-tl/Kamori/raw/master/banner.sh) && cd ~/Kamori && python3 -m kamori' > ~/.bash_profile"

    printf "\r\033[K\033[0;32mAutostart enabled!\e[0m\n"
fi

echo -e "\033[0;96mStarting Kamori...\033[0m"
echo -e "\033[2J\033[3;1f"

printf "\033[1;32mKamori is starting...\033[0m\n"

eval "python3 -m kamori"
